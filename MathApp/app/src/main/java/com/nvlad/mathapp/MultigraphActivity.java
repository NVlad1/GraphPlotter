...
public class MultigraphActivity extends ActionBarActivity implements OnKeyboardStateChangedListener{
...
//        spinner = new Spinner[NMax];
        ...
        String phi = "&#966;";
        String[] data = {"y(x)", "x(y)", "r("+ Html.fromHtml(phi)+"=x)", "x(t)=", "implicit"};
...
//                    Toast.makeText(getBaseContext(), "Position = " + position, Toast.LENGTH_SHORT).show();
        ...
        Fedit[5].setTextColor(Color.YELLOW);
        Fedit[6].setTextColor(Color.MAGENTA);
