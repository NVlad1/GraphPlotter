...
public class CustomKeyboard {
    ...
    public final static int CodeAnotherKeyboard    = 55007;
    public final static int CodeSin = 56001;
    public final static int CodeCos = 56002;
    public final static int CodeTg = 56003;
    public final static int CodeCtg = 56004;
    public final static int CodeExp = 56005;
    public final static int CodeSqrt = 56006;
    public final static int CodeAbs = 56007;
    public final static int CodeLog = 56008;
    public final static int CodeLn = 56009;
    public final static int CodeAsin = 56010;
    public final static int CodeAcos = 56011;
    public final static int CodeAtg = 56012;
    public final static int CodeSh = 56013;
    public final static int CodeCh = 56014;
...
//          if( focusCurrent==null || focusCurrent.getClass()!=EditText.class ) return;
    ...
    public void showCustomKeyboard2( View v ) {
        mKeyboardView2.setVisibility(View.VISIBLE);
        mKeyboardView2.setEnabled(true);
        if( v!=null ) ((InputMethodManager)mHostActivity.getSystemService(Activity.INPUT_METHOD_SERVICE)).hideSoftInputFromWindow(v.getWindowToken(), 0);
    }
